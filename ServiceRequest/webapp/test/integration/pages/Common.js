sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zz/ServiceRequest/app", ".html");
		...
		return Opa5.extend("zz.ServiceRequest.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zz/ServiceRequest/localService/mockserver"], function (mockserver) {
